...
public class ReportServiceImpl implements ReportService {
	...
	public List<String> getUniquePlanStatuses() {
		return detailsRepo.findPlanStatuses();
	}
	...
	public void generateExcel(HttpServletResponse response) throws Exception {
		List<EligibilityDetails> entities = detailsRepo.findAll();
		...
		for(EligibilityDetails entity : entities) {
			...
			dataRow.createCell(0).setCellValue(entity.getEligName());
	...
	public void generatePdf(HttpServletResponse response) throws Exception {
	    ...
	    pdfTable.setWidths(new float[]{1.5f, 3.5f, 3.0f, 1.0f, 3.0f});
		...
		for(EligibilityDetails entity : entities) {
			pdfTable.addCell(entity.getEligName());
			pdfTable.addCell(entity.getEmail());
			pdfTable.addCell(String.valueOf(entity.getMobileNo()));
			pdfTable.addCell(String.valueOf(entity.getGender()));
